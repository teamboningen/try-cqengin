 ...
 */
public class TryCQEngineWithSQLMain {

	public static void main(String[] args) {

		// generate Attribute
		SQLParser<Car> parser = SQLParser.forPojoWithAttributes(Car.class, createAttributes(Car.class, MemberFilters.GETTER_METHODS_ONLY));
